...
const (
	CreateUserService_CreateUser_FullMethodName = "/proto.CreateUserService/CreateUser"
)
...
func (c *createUserServiceClient) CreateUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (UnimplementedCreateUserServiceServer) CreateUser(context.Context, *User) (*Response, error) {
...
var CreateUserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.CreateUserService",

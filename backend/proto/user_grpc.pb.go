...
type UserServiceClient interface {
	...
	LoginUser(ctx context.Context, in *LoginForm, opts ...grpc.CallOption) (*UserResponse, error)
}
...
func (c *userServiceClient) LoginUser(ctx context.Context, in *LoginForm, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
...
type UserServiceServer interface {
	...
	LoginUser(context.Context, *LoginForm) (*UserResponse, error)
...
func (UnimplementedUserServiceServer) LoginUser(context.Context, *LoginForm) (*UserResponse, error) {
...
func _UserService_LoginUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).LoginUser(ctx, req.(*LoginForm))
	}
	return interceptor(ctx, in, info, handler)
}
